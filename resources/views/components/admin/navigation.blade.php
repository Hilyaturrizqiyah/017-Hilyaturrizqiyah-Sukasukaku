...
">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            ...
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 {{ Request::is('admin/users*') ? 'bg-gray-100 text-neutral-700' : 'text-neutral-700' }}" href="#">
